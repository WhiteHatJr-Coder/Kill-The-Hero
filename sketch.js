...
function setup() {
  ...
  blocks8 = new BlockGreen(730,135,30,40);
  //top
  blocks9 = new BlockPink(700,95,30,40);
...
function draw() {
  ...
  textSize(15);
  fill("black");
  text("First Shot You Have Sling, Hold Mouse To Re-Claim The Pointer",200,100);

  textSize(28);
  fill("Black");
  text("DO YOUR PART IN THE COMUNITY THROW AWAY YOUR THRASH!",10,50);
